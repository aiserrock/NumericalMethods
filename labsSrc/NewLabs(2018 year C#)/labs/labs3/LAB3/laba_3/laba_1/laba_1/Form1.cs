...
namespace laba_1
{
    public partial class Form1 : Form
    {
        ...
        double Alfa=1, Betta=1, Pi=1, Delta=1, Epsilon=1, Fi=1;
        ...
        private void button_UP_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Epsilon = Convert.ToDouble(par_E.Text);
        ...
        void method_of_EulerX()//рисует интегральную кривую и выводит n_max
        {
            ...
            {
                x1 = x;
                x = x + Tau * (Math.Pow((Alfa * x + Betta * y),2) + Epsilon);
                y = y + Tau * (Math.Pow((Pi * x + Delta * y), 2) + Fi); 
                list1.Add(x, y);
            }
